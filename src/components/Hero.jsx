    ...
    return (
        <div className='bg-black pt-20'>
            <div className='w-10/12 mx-auto pb-5 px-5'>
                <div className='pb-20'>
                    <h1 className='text-white text-2xl md:text-5xl lg:text-7xl md:w-3/8'>Craft your perfect resume, effortlessly</h1>
                </div>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
                    ...
                    <div>
                        <div className='text-center'>
                            <p className='text-white'>Resu-Ai helps you create professional resumes with Ai.
                        ...
                        <div className='flex justify-between pb-10 pt-20 md:pt-30'>
                            <p className='w-2/8 text-white'>AI-Powered Resume Building Platform</p>
                            <p className='w-2/8 text-white'>%50k+ Resumes Build Successfully</p>
                        </div>
                    </div>
                </div>
            </div>
